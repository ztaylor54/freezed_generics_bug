...
mixin _$Outer<T, U> {
  ...
  Inner<U> get secondType => throw _privateConstructorUsedError;
...
abstract class $OuterCopyWith<T, U, $Res> {
  ...
  @useResult
  $Res call({T firstType, Inner<U> secondType});
}
    ...
    return _then(_$OuterImpl<T, U>(
      firstType: freezed == firstType
          ...
          : firstType // ignore: cast_nullable_to_non_nullable
              as T,
      secondType:
          freezed == secondType ? _value.secondType : secondType as Inner<U>,
    ));
  }
}
...
abstract class _Outer<T, U> implements Outer<T, U> {
  const factory _Outer(
      ...
      required final Inner<U> secondType}) = _$OuterImpl<T, U>;
